...
/**
 * Provides necessary meta information about the facerecognitionaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.5
 */
public class FacerecognitionaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(FacerecognitionaddonHMCExtension.class.getName());

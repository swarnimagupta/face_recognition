...
import com.accenture.constants.FacerecognitionaddonConstants;



/**
 * This is the extension manager of the Facerecognitionaddon extension.
 */
public class FacerecognitionaddonManager extends GeneratedFacerecognitionaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FacerecognitionaddonManager.class.getName());
	 ...
	 */
	public static FacerecognitionaddonManager getInstance()
	{
		return (FacerecognitionaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FacerecognitionaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FacerecognitionaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FacerecognitionaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FacerecognitionaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FacerecognitionaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}

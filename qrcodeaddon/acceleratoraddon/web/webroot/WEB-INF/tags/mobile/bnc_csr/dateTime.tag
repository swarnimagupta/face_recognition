...
<div class="datetime_block">
	...
	<div class="date_block">
		...
		<ul>
			<li><a href="#"><img src="${commonResourcePath}/../../addons/qrcodeaddon/mobile/common/bnc_images/calender_icon.png" alt="calender" border="0"/></a></li>
			<li>From :</li>
			<li>
	...
	<div class="time_block">
		<ul>
			<li><a href="#"><img src="${commonResourcePath}/../../addons/qrcodeaddon/mobile/common/bnc_images/clock_icon.png" alt="clock" border="0"/></a></li>
			<li>From :</li>
			<li>

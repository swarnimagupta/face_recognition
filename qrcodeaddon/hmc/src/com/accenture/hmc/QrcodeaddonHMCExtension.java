...
/**
 * Provides necessary meta information about the qrcodeaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.3
 */
public class QrcodeaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(QrcodeaddonHMCExtension.class.getName());

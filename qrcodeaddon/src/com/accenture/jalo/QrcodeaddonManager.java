...
/**
 * This is the extension manager of the Qrcodeaddon extension.
 */
public class QrcodeaddonManager extends GeneratedQrcodeaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(QrcodeaddonManager.class.getName());
	 ...
	 */
	public static QrcodeaddonManager getInstance()
	{
		return (QrcodeaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				QrcodeaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public QrcodeaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of QrcodeaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of QrcodeaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of QrcodeaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}

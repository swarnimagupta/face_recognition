...
/**
 * This is the extension manager of the Qrcode extension.
 */
public class QrcodeManager extends GeneratedQrcodeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(QrcodeManager.class.getName());
	...
	{
		return (QrcodeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				QrcodeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public QrcodeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of QrcodeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of QrcodeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of QrcodeManager called, current tenant: " + getTenant().getTenantID());
		}
	}

...
/**
 * This is the extension manager of the Servicecore extension.
 */
public class ServicecoreManager extends GeneratedServicecoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ServicecoreManager.class.getName());
	 ...
	 */
	public static ServicecoreManager getInstance()
	{
		return (ServicecoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ServicecoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ServicecoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ServicecoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ServicecoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ServicecoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
